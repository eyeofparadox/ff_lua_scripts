-- 3d perlin spherical map v.1.0.1 -- improved perlin noise
...
-- noise block
	--[[
		...
		http://flafla2.github.io/2014/08/09/perlinnoise.html
			source url (131 characters) resulted in the following TinyURL (28 characters):
				https://tinyurl.com/2r3h3rar
				[Open in new window]
			preview TinyURL:
				https://tinyurl.com/preview/2r3h3rar
				[Open in new window]
	]]-- 
