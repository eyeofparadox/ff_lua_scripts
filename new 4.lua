...
function get_polar_noise_loop(x, y, zoff, params)
    ...
    -- zoff is passed as a parameter now

    -- Call noise_octaves with arbitrary base coordinates
    local noise_value = noise_octaves(xoff, yoff, zoff, frequency, octaves, persistence, lacunarity, seed)
