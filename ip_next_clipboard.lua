-- 3d perlin spherical map v.0.0.4 - improved perlin noise, distortion power
-- addition of '* ch_distortion' improved cloud fractal
function prepare()
 -- constants
...
function get_sample(x, y)
	...
	elseif mode == 5 then
		...
		r, g, b, a = blend_multiply(r2, g2, b2, a2, r1, g1, b1, l, 1 - l, hdr)
		-- atmosphere = true
		r, g, b, a = blend_normal(r, g, b, a, r3, g3, b3, a3, 0.2, hdr)
		-- blends in clouds overlay
		r, g, b, a = blend_screen(r, g, b, a, r1, g1, b1, a1, l * 0.9)
		r, g, b, a = blend_soft_light(r, g, b, a, r1, g1, b1, a1, nr)
		r, g, b, a = blend_soft_light(r, g, b, a, r1, g1, b1, a1, ng)
		r, g, b, a = blend_soft_light(r, g, b, a, r1, g1, b1, a1, nb)
		return r, g, b, a 
	else
		-- map = true
		-- rgban = true
...
function gen_perlin_octaves(ch_noise, ch_roughness, ch_contrast, ch_distortion, ch_noise_x, ch_noise_y, ch_noise_z)
	...
	for octave_index = 1, OCTAVES_COUNT do
		...
		distortion = opacity * perlin:noise(rd + ch_noise_x * size,gd + ch_noise_y * size, bd + ch_noise_z * size) * ch_distortion
